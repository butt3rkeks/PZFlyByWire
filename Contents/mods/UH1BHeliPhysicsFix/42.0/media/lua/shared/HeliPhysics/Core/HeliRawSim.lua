--[[
    HeliRawSim — Pure simulation model (ideal trajectory)
...
function HeliRawSim.reset(posX, posZ)
    _simPosX = posX
    _simPosZ = posZ
    _simVelX = 0
    _simVelZ = 0
...
function HeliRawSim.advance(desiredVelX, desiredVelZ, dt, inertia)
...
function HeliRawSim.snapPosition(posX, posZ)
    _simPosX = posX
    _simPosZ = posZ
end
...
function HeliRawSim.blendToward(actualX, actualZ, blend)
