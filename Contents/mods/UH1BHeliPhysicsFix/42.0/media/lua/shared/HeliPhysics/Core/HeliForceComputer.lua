--[[
    HeliForceComputer — Pure math force computation
...
function HeliForceComputer.computeCorrectionForce(errX, errZ, errRateX, errRateZ, errMag,
...
function HeliForceComputer.computeThrustForce(desiredVelY, savedVelY, mass, Kp, gravity, subSteps, physicsDelta, applyGravComp)
    if subSteps > 0 then
