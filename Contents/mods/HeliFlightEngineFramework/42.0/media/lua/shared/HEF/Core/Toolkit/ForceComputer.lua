--[[
    ForceComputer — Pure math force computation
    ...
    Moved from Engines/FBW/FBWForceComputer.lua to Core/Toolkit/ — engine-agnostic.
]]
...
function ForceComputer.computeCorrectionForce(errX, errZ, errRateX, errRateZ, errMag,
...
function ForceComputer.computeThrustForce(desiredVelY, savedVelY, mass, verticalGain, gravity, subSteps, physicsDelta, applyGravComp)
    if subSteps > 0 then
...
FBWForceComputer = ForceComputer
