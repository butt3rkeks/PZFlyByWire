--[[
    FlightModel — Vertical flight behavior (thin wrapper around Toolkit/VerticalModel)
    ...
    Moved from Engines/FBW/FBWFlightModel.lua to Core/Toolkit/ — engine-agnostic.
]]
...
function FlightModel.computeVerticalTarget(ctx, freeMode)
