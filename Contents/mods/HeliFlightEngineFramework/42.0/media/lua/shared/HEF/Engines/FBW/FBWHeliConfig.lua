...
function HeliConfig.GetEnginedead() return HeliConfig.get("enginedead") end
--- @return number Engine-dead fall speed (Bullet Y/s)
function HeliConfig.GetDeadfall() return HeliConfig.get("deadfall") end
--- @return number Vertical PD gain (responsiveness)
function HeliConfig.GetKp() return HeliConfig.get("kp") end
...
function HeliConfig.GetHspeed() return HeliConfig.get("hspeed") end
--- @return number Yaw rotation speed (deg/frame at target FPS)
function HeliConfig.GetYawspeed() return HeliConfig.get("yawspeed") end

-- Runtime-only (session overrides)
--- @return number Horizontal position error P gain
function HeliConfig.GetPgain() return HeliConfig.get("pgain") end
--- @return number Horizontal position error D gain (damping)
function HeliConfig.GetDgain() return HeliConfig.get("dgain") end
--- @return number Max position error (tanh saturation, meters)
function HeliConfig.GetMaxerr() return HeliConfig.get("maxerr") end
--- @return number Velocity damping strength
function HeliConfig.GetFstopgain() return HeliConfig.get("fstopgain") end
--- @return number Yaw correction strength
function HeliConfig.GetYawgain() return HeliConfig.get("yawgain") end
--- @return number Auto-leveling speed multiplier
function HeliConfig.GetAutolevel() return HeliConfig.get("autolevel") end
