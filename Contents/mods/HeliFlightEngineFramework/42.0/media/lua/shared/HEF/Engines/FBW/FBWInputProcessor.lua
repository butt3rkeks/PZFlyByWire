--[[
    ...
    Reads: FBWOrientation (body angles), HeliConfig (tuning), HeliTerrainUtil (walls),
...
-------------------------------------------------------------------------------------
function FBWInputProcessor.computeRotationDeltas(keys, fpsMultiplier, heliType, playerObj, vehicle, tempVector2, freeMode)
